...
hist(videotimearray,breaks=24,xlim=c(0,24), main="Plot showing the distribution of study time for students", col="skyblue", xlab="Time Of Day", ylab="Frequency", border="blue")
